                              ...
                              const char *bundle_path, const LV2_Feature *const *features)
{
    ...
    b3o->o_bias = b3o->o_feedback = b3o->o_sagtobias = b3o->o_postfeed = b3o->o_globfeed =
        b3o->o_gainin = b3o->o_gainout = -1;
...
static const LV2_Descriptor descriptor = {B3O_URI, instantiate, connect_port, activate,
