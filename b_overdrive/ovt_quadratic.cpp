...
static char *controllerNames[NOF_MIDI_CONTROLLERS] = {"setQuadraticThreshold"};
int getNofMC_quadratic() { return NOF_MIDI_CONTROLLERS; }
char *getMCNam_quadratic(int i) { return controllerNames[i]; }
/*
 ...
 */
void ini_quadratic() { codeln("cfg_quadratic (0.5);"); }
 ...
 */
void xfr_quadratic(char *xs, char *ys)
{
    char buf[BUFSZ];
