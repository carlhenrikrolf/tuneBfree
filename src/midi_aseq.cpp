...
int aseq_open(char *port_name)
{
    ...
    if ((err = snd_seq_create_simple_port(
             seq, "midi_in", SND_SEQ_PORT_CAP_WRITE | SND_SEQ_PORT_CAP_SUBS_WRITE,
 ...
 */
static void process_seq_event(void *inst, const snd_seq_event_t *ev)
{
