...
void setReverbInputGain(struct b_reverb *r, float g) { r->inputGain = g; }
...
float *reverb(struct b_reverb *r, const float *inbuf, float *outbuf, size_t bufferLengthSamples)
{
